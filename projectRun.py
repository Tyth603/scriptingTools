...
proj1UnitNameList = ["Meeting and Greeting", "Getting Help with your Language Learning",
...
proj1UnitMap = {"Meeting and Greeting": ["Meeting-and-Greeting"],
...
if __name__ == "__main__":
    organize = organizeB4U(proj1UnitNameList, languageDict, proj1UnitMap, "supplementalVocabCoursesNonESL")
